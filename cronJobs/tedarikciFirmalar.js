...
// her gün saat 09:00'da çalışacak cronJob:  UVT tarafından yazılan A1 ve A2 deki tedarikçi firmaları kontrol edilip portala aktarılmasını sağlayan senkronizasyon
module.exports = async function tedarikciFirmalar() {
    ...
    cron.schedule("00 09 * * *", async function () {
        ...
        INNER JOIN ALIS_KAT as alisKat ON firma.KAYITNO = alisKat.FIRMALAR_KAY
                    `
            // portaldaki A1 ve A2 deki firmaların kontrol edilip, portala aktarılmasını gerçekleştirir
